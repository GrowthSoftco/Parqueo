  ...
  return (
    <>
      <button
        ...
        style={{ background: '#fff', fontSize: '13px', padding: '8px 16px' }}
      >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-5">
              <p style={{ color: '#666', fontSize: '13px' }}>Ingresa la placa del vehículo</p>
              <button
                onClick={() => setIntl(v => !v)}
              ...
              >
                <span style={{ width: 6, height: 6, borderRadius: 9999, background: intl ? '#3b82f6' : '#444' }} />
                Internacional
              </button>
            </div>
                  ...
                  <div key={i} className="flex items-center gap-2">
                    <input
                      ...
                      style={{
                        ...
                        height: 56,
                        background: '#0f0f0f',
                        border: `1.5px solid ${chars[i] ? '#3b82f6' : '#232323'}`,
                        borderRadius: 12,
                        color: '#fff',
                        fontSize: 22,
                        fontWeight: 600,
                      ...
                      onBlur={e => (e.currentTarget.style.borderColor = chars[i] ? '#3b82f6' : '#232323')}
                    />
            ...
            <p style={{ color: '#888', fontSize: '13px', marginBottom: '8px' }}>Categoría</p>
              ...
              {categorias.map(c => {
                ...
                return (
                  <button
                    ...
                    style={{ background: on ? '#1e1e1e' : '#0f0f0f', border: on ? '1.5px solid #6b6b6b' : '1.5px solid #232323' }}
                  >
                    <Icon size={18} color={on ? '#fff' : '#888'} />
                    <span style={{ color: on ? '#fff' : '#888', fontSize: '11.5px' }}>{c.nombre}</span>
                  </button>
                )
              })}
            </div>
            ...
            <button
              ...
              style={{ background: '#fff', fontSize: '14px', opacity: pending ? 0.6 : 1 }}
            >
